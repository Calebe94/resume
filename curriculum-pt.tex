...
\cventry{2023 -- Presente}{Desenvolvedor Python Sênior}{LuizaLabs - Magalu Cloud}{Curitiba - PR}{}{
\begin{itemize}
\item Faço parte do time de Research \& Development, colaborando de maneira estreita com as equipes de Virtual Machine e de Block Storage do Magalu Cloud.
\item Rotineiramente utilizo ferramentas avançadas como Openstack, Juju e Ansible para a automação de processos e o aprimoramento das operações em nosso ambiente de nuvem.
\item Responsável pelo desenvolvimento de spikes e criação de soluções inovadoras, visando a otimização contínua das rotinas e processos no Magalu Cloud.
\end{itemize}
}

\cventry{2020 -- 2023}{Analista de Sistemas Embarcados}{Grupo T2I}{Curitiba - PR}{}{
\begin{itemize}
\item Desenvolvimento e manutenção de sistemas embarcados usando C, C++, Python e FreeRTOS.
...
\begin{itemize}
\item Participação no desenvolvimento de sistemas embarcados com foco em C/C++ e Linux.
...
\begin{itemize}
\item Participação no desenvolvimento de sistemas embarcados com foco em C, C++ e FreeRTOS.
\end{itemize}
}

\section{Habilidades Técnicas}
\cvitem{Linguagens}{C, C++, C\#, Python, Shell Script, Javascript, HTML, CSS, Flutter, Flask, Django, NodeJS, NestJS, Typescript}
\cvitem{SO}{Debian, Linux, FreeRTOS}
...
\section{Educação}
\cventry{2015 -- 2023}{Engenharia de Computação}{Universidade Positivo}{Curitiba}{}{}
